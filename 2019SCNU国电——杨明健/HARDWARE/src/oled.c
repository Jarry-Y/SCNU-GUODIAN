...
{ 	
 	...
 	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD, ENABLE);	 //Ê¹ÄÜPC,D,G¶Ë¿ÚÊ±ÖÓ

	GPIO_InitStructure.GPIO_Pin =	GPIO_Pin_6|GPIO_Pin_7;	 //PD3,PD6ÍÆÍìÊä³ö  
  ...
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//ÉÏÀ­
 	...
 	GPIO_SetBits(GPIOD,GPIO_Pin_6|GPIO_Pin_7);	//PD3,PD6 Êä³ö¸ß
...
{
	OLED_ShowCHinese(0,0,0);//³Ì
	OLED_ShowCHinese(13,0,1);//¿Ø
	OLED_ShowCHinese(26,0,2);//·Å
	OLED_ShowCHinese(39,0,3);//´ó
	...
	/*OLED_ShowCHinese(0,3,4);//½Ø
	OLED_ShowCHinese(13,3,5);//Ö¹
	OLED_ShowCHinese(26,3,6);//Æµ
	OLED_ShowCHinese(39,3,7);//ÂÊ
	...
	OLED_ShowCHinese(0,6,8);//Ñà
	OLED_ShowCHinese(13,6,9);//Ôó
	OLED_ShowCHinese(26,6,10);//ê»
	OLED_ShowCHinese(52,6,11);//ÖÜ
	OLED_ShowCHinese(65,6,12);//ÐÀ
	OLED_ShowCHinese(78,6,13);//ÐÀ
