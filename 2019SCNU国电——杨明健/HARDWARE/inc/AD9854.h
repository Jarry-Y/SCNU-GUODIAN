...
#define AD9854_RST    PDout(4)   //AD9854复位端口
#define AD9854_UDCLK  PDout(1)   //AD9854更新时钟
#define AD9854_WR     PDout(3)  //AD9854写使能，低有效
#define AD9854_RD     PDout(5)   //AD9854读使能，低有效
#define AD9854_OSK    PDout(0)   //AD9854 OSK控制端
#define AD9854_FDATA  PDout(2)   //AD9854 FSK,PSK控制

#define AD9854_DataBus GPIOE->BSRRL		//AD9854数据位，E口低八位
#define AD9854_AdrBus  GPIOE->BSRRL		//AD9854地址位，E口高八位的后六位
